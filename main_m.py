...
def parse_args():
    ...
    args.add_argument("-outfolder", "--output_folder",
                      default="./checkpoints/ogb5/", help="Folder name to save the models.")
    args.add_argument("-outprint_file", "--outprint_file",
                      default="./outprint5.txt", help="File name to print information.")

    # arguments for GAT
    args.add_argument("-b_gat", "--batch_size_gat", type=int,
                      default=262144, help="Batch size for GAT")  # full batch
    ...
    args.add_argument("-b_conv", "--batch_size_conv", type=int,
                      default=8192, help="Batch size for conv")
